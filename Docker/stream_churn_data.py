...
Usage:
    ...
    --user        MySQL user             (default churn_user)
    --password    MySQL password         (default churn_pass)
...
def main():
    ...
    p.add_argument("--user",                  default="churn_user",  help="MySQL user")
    p.add_argument("--password",              default="churn_pass",  help="MySQL password")
